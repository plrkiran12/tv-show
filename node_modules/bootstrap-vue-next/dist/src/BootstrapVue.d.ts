...
import { BootstrapVueOptions, ComponentType } from './types';
...
export declare const createBootstrap: ({ components, directives, plugins: pluginData, aliases, }?: Readonly<BootstrapVueOptions>) => Plugin;
/**
 * Resolver for unplugin-vue-components
 */
export declare const BootstrapVueNextResolver: ({ aliases, directives, components, }?: Readonly<Pick<BootstrapVueOptions, 'directives' | 'components'> & {
